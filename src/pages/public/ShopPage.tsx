  ...
  return (
    <div className="bg-[#f6f2ec] text-zinc-950">
      <section className="relative overflow-hidden bg-[#2f261e] py-14 md:py-24 text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-5 md:px-4 lg:grid-cols-[1fr_0.88fr]">
          ...
          <aside className="relative hidden overflow-hidden rounded-2xl md:rounded-sm border border-white/12 bg-white/[0.055] p-6 md:p-8 shadow-lg md:shadow-2xl backdrop-blur lg:block">
            ...
            <div className="relative">
              <div className="flex items-center gap-5">
                <div className="flex h-24 w-24 items-center justify-center rounded-3xl bg-[#fff8f0] shadow-md md:shadow-xl">
      ...
      <section id="produtos" className="bg-white py-14 md:py-24">
        <div className="mx-auto max-w-7xl px-5 md:px-4">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div className="max-w-3xl">
              <p className="text-sm font-bold uppercase tracking-[0.45em] text-[#b83336]">Catálogo</p>
              <h2 className="mt-5 font-serif text-4xl font-light text-[#2f261e] md:text-6xl">Produtos oficiais.</h2>
            ...
            <article className="mt-12 overflow-hidden rounded-2xl md:rounded-sm border border-zinc-200 bg-[#f6f2ec] shadow-sm">
              <div className="grid gap-0 lg:grid-cols-[0.95fr_1.05fr]">
                <div className="relative flex min-h-[360px] items-center justify-center overflow-hidden bg-[#2f261e] p-6 md:p-10">
                  ...
                  <button type="button" onClick={() => openLightbox(featuredProduct, 0)} className="relative rounded-[2rem] bg-white p-5 md:p-7 shadow-lg md:shadow-2xl transition hover:scale-[1.02]">
                ...
                <div className="p-6 md:p-12">
                  ...
                  <div className="mt-6 flex flex-wrap items-center gap-3">
                    <span className="rounded-full bg-white px-5 md:px-4 py-2 text-xs font-black uppercase tracking-wide text-[#b83336] shadow-sm">{formatCurrency(featuredProduct.price, featuredProduct.price_label)}</span>
                    <span className="rounded-full bg-white px-5 md:px-4 py-2 text-xs font-black uppercase tracking-wide text-zinc-600 shadow-sm">{stockStatusLabels[featuredProduct.stock_status]}</span>
                  </div>
                ...
                <article id={`produto-${product.id}`} key={product.id} className="group flex h-full flex-col overflow-hidden rounded-2xl md:rounded-sm border border-zinc-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
                  <div className="relative flex h-80 items-center justify-center overflow-hidden bg-[#2f261e]">
                    ...
                    <button
                      ...
                      className="relative h-52 w-52 rounded-[2rem] bg-white p-6 shadow-lg md:shadow-2xl transition duration-500 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-[#d6a7a0]/60 group-hover:scale-105"
                  ...
                  <div className="flex flex-1 flex-col bg-white p-5 md:p-7">
                    ...
                    {(productImages.length > 1 || productVideos.length > 0) && (
                      <div className="mt-5 space-y-3">
                        ...
                        {productVideos[0] && (
                          <a href={productVideos[0]} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full border border-zinc-200 bg-white px-5 md:px-4 py-2 text-xs font-black uppercase tracking-wide text-[#2f261e] transition hover:border-[#b83336] hover:text-[#b83336]">
                            <Sparkles size={14} />
      ...
      <section className="bg-[#f6f2ec] py-14 md:py-20">
        <div className="mx-auto max-w-7xl px-5 md:px-4">
      ...
      <section className="bg-[#2f261e] py-14 md:py-20 text-white">
      ...
      {isCartOpen && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm" role="dialog" aria-modal="true">
          <div className="absolute right-0 top-0 flex h-full w-full max-w-xl flex-col bg-[#f6f2ec] shadow-lg md:shadow-2xl">
                    ...
                    <form onSubmit={handleCheckoutSubmit} className="rounded-2xl md:rounded-sm border border-zinc-200 bg-white p-5 shadow-sm">
                      ...
                      <div className="mt-5 grid gap-4 md:grid-cols-2">
                        <label className="grid gap-2 text-sm font-bold text-zinc-700">
                          Nome
                          <input required value={checkoutForm.customerName} onChange={(event) => setCheckoutForm((current) => ({ ...current, customerName: event.target.value }))} className="rounded-md border border-zinc-200 px-5 md:px-4 py-3 outline-none focus:border-[#b83336]" />
                        </label>
                        <label className="grid gap-2 text-sm font-bold text-zinc-700">
                          Telefone
                          <input required value={checkoutForm.phone} onChange={(event) => setCheckoutForm((current) => ({ ...current, phone: event.target.value }))} className="rounded-md border border-zinc-200 px-5 md:px-4 py-3 outline-none focus:border-[#b83336]" />
                        </label>
                        <label className="grid gap-2 text-sm font-bold text-zinc-700 md:col-span-2">
                          Email
                          <input type="email" value={checkoutForm.email} onChange={(event) => setCheckoutForm((current) => ({ ...current, email: event.target.value }))} className="rounded-md border border-zinc-200 px-5 md:px-4 py-3 outline-none focus:border-[#b83336]" />
                        </label>
                        <label className="grid gap-2 text-sm font-bold text-zinc-700 md:col-span-2">
                          ...
                          <input
                            ...
                            className="rounded-md border border-zinc-200 px-5 md:px-4 py-3 outline-none focus:border-[#b83336]"
                            placeholder="Ex.: 123"
                          />
                        ...
                        <label className="grid gap-2 text-sm font-bold text-zinc-700 md:col-span-2">
                          ...
                          <select value={checkoutForm.paymentMethod} onChange={(event) => setCheckoutForm((current) => ({ ...current, paymentMethod: event.target.value as CheckoutFormState['paymentMethod'] }))} className="rounded-md border border-zinc-200 px-5 md:px-4 py-3 outline-none focus:border-[#b83336]">
                        ...
                        <label className="grid gap-2 text-sm font-bold text-zinc-700 md:col-span-2">
                          Entrega / recolha
                          <select value={checkoutForm.deliveryMethod} onChange={(event) => setCheckoutForm((current) => ({ ...current, deliveryMethod: event.target.value as CheckoutFormState['deliveryMethod'] }))} className="rounded-md border border-zinc-200 px-5 md:px-4 py-3 outline-none focus:border-[#b83336]">
                      ...
                      <label className="mt-4 grid gap-2 text-sm font-bold text-zinc-700">
                        Observações
                        <textarea rows={4} value={checkoutForm.notes} onChange={(event) => setCheckoutForm((current) => ({ ...current, notes: event.target.value }))} className="rounded-md border border-zinc-200 px-5 md:px-4 py-3 outline-none focus:border-[#b83336]" placeholder="Ex.: nome do atleta, escalão, melhor horário de contacto, informação sobre quotas..." />
                      </label>
      ...
      {lightbox && currentLightboxImage && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 px-5 md:px-4 py-6 backdrop-blur-sm" role="dialog" aria-modal="true">
          <button
            type="button"
          ...
          <div className="mx-auto flex max-h-full w-full max-w-6xl flex-col gap-4">
            <div className="flex items-center justify-between gap-4 text-white">
              ...
              <span className="shrink-0 rounded-full bg-white/10 px-5 md:px-4 py-2 text-xs font-black uppercase tracking-wide text-white">
                {lightbox.imageIndex + 1} / {lightboxImages.length}
              </span>
            </div>

            <div className="relative flex min-h-[52vh] items-center justify-center overflow-hidden rounded-2xl bg-white p-4 shadow-lg md:shadow-2xl md:min-h-[68vh] md:p-8">
